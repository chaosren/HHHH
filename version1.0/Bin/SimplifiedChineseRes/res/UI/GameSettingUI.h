...
const unsigned long ID_GAMESETTINGUI_CTRL_BUTTON_4					= 4;
const unsigned long ID_GAMESETTINGUI_CTRL_BUTTON_3					= 3;
const unsigned long ID_GAMESETTINGUI_CTRL_BUTTON_2					= 2;
const unsigned long ID_GAMESETTINGUI_CTRL_BUTTON_1					= 1;
