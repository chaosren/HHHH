...
--local info_txt="玩法：在一塊7X7的方格棋盤上，你要做的就是橫向、縱向、斜向連接四個相同顏色的方塊，以完成消除。每次移動方塊後，都會有新的方塊出現；只要一個回合中有方塊被消除，這一回合就不會有新方塊出現。連續消除會有額外的分數獎勵，遊戲難度會隨著分數慢慢加大，主要是每一回合新增的方塊數目會增加。\n\n獎勵：玩家獲取的最高積分將被記錄，每日22:00結算，排名前二十的玩家將會獲得獎勵。"
local info_txt="相傳，上古伏羲氏時，洛陽東的黃河中浮出龍馬，背負河圖，獻給伏羲。伏羲依此而演成八卦。又相傳，大禹時，洛陽西的洛河中浮出神龜，背馱洛書，獻給大禹。大禹依此治水成功，遂劃天下為九州。今河圖洛書現，你能解開其中的千年謎題嗎？\n\n玩法：在一塊7x7的方格棋盤上，你要做的就是橫向、縱向、斜向連接四個相同顏色的方塊，以完成消除。每次移動方塊後，都會有新的方塊出現；只要一個回合中有方塊被消除，這一回合就不會有新方塊出現。連續消除會有額外的分數獎勵，遊戲難度會隨著分數慢慢加大，主要是每一回合新增的方塊數目會增加。\n\n獎勵：玩家獲取的最高積分將被記錄，每日22:00結算，排名前二十的玩家將會獲得銀幣獎勵。"
