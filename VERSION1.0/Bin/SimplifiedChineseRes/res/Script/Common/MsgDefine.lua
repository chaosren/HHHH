...
NMSG_Type = 
{
  ...
  _MSG_LANDLORDS_SOS_LIST			= _MSG_GENERAL+8127;		--斗地主玩家信息  
    ...
    _MSG_GMCOMMAND              = 139,      --gm com
     ...
     _MSG_WORLDBATTLE_PLAYERINFO     = _MSG_GENERAL + 7010, 
     _MSG_WORLDBATTLE_OPERATE     = _MSG_GENERAL + 7011,  
	...
	_MSG_BATTLECITY_PLAYERINFO			= _MSG_GENERAL+8172;		--//玩家信息
	_MSG_BATTLECITY_BATTLEINFO			= _MSG_GENERAL+8173;		--//战斗相关信息
	_MSG_BATTLECITY_PLAYERLIST			= _MSG_GENERAL+8174;		--//玩家队列
	_MSG_BATTLECITY_CHANGEPLAYERLIST	= _MSG_GENERAL+8175;		--//改变玩家列表
	_MSG_BATTLECITY_ENCOURAGEINFO		= _MSG_GENERAL+8176;		--//鼓舞信息
	_MSG_BATTLECITY_STORAGEINFO			= _MSG_GENERAL+8177;		--//仓库
	_MSG_BATTLECITY_ACTION				= _MSG_GENERAL+8178;		--//动作
	_MSG_BATTLECITY_ACTION_RET			= _MSG_GENERAL+8179;		--//动作返回
